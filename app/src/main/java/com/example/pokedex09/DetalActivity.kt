...
import com.example.pokedex09.databinding.ActivityDetalBinding
import com.example.pokedex09.databinding.ActivityMainBinding
import com.google.android.material.progressindicator.LinearProgressIndicator

class DetailActivity : AppCompatActivity() {
    lateinit var binding: ActivityDetalBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.detalContainer.setBackgroundColor(Color.parseColor(model.backgroundColor))


        binding.tvNameDetal.text = model.name
